    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page-title { font-size: 20px; font-weight: 700; color: #1a3556; margin-bottom: 4px; }
        ...
        .stat-card.green .stat-value { color: #1a3556; }
        ...
        .animal-bar { height: 100%; border-radius: 4px; background: #1a3556; transition: width 0.5s; }
            ...
            <div className="two-col">
              ...
              <div className="card">
                ...
                {stats.totalCases === 0 ? (
                  ...
                  <>
                    ...
                    <div className="urgency-row">
                      <span className="urgency-label" style={{ color: "#1a3556" }}>🟢 Low</span>
                      <div className="urgency-bar-wrap">
                        <div className="urgency-bar" style={{ width: `${stats.totalCases ? (stats.lowCases / stats.totalCases * 100) : 0}%`, background: "#1a3556" }} />
                      </div>
              ...
              <div className="card">
                ...
                <div className="revenue-row">
                  ...
                  <span className="revenue-amount" style={{ color: "#1a3556" }}>
            ...
            <div className="card">
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                {[
                  ...
                  <a key={a.label} href={a.href} style={{ background: "#f0faf4", border: "1px solid #d4f0e0", color: "#1a3556", padding: "8px 16px", borderRadius: 8, fontSize: 13, fontWeight: 600, textDecoration: "none", transition: "all 0.15s" }}>
                    {a.label}
                  </a>
                ))}
              </div>
